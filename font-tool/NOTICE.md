...
axis conventions). Bold is Noto Sans CJK JP Bold. Noto CJK has no true italic, so
the italic and bold-italic glyphs are the upright Noto glyphs sheared about 12
degrees (faux-italic); they are still Noto, modified, which the OFL permits.
